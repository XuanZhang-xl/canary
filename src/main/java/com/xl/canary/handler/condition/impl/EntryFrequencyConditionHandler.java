 ...
 */
@Component("entryFrequencyConditionHandler")
@CouponConditionHandler(condition = CouponConditionEnum.ENTRY_FREQUENCY)
public class EntryFrequencyConditionHandler extends ArithmeticDescribeCouponConditionHandler {
}
