 ...
 */
@Component("greatThanOrEqualOperatorHandler")
@ArithmeticOperatorHandler(operator = ArithmeticOperatorEnum.GREAT_THAN_OR_EQUAL)
public class GreatThanOrEqualOperatorHandler implements IArithmeticOperatorHandler {
