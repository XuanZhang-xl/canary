 ...
 */
@Component("lessThanOrEqualOperatorHandler")
@ArithmeticOperatorHandler(operator = ArithmeticOperatorEnum.LESS_THAN)
public class LessThanOrEqualOperatorHandler implements IArithmeticOperatorHandler {

    Logger logger = LoggerFactory.getLogger(LessThanOrEqualOperatorHandler.class);
